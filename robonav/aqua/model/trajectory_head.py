...
class TrajectoryHead(BaseModel):
    def __init__(
        ...
        **kwargs,
        ...
        self.temporal_conv1 = nn.Conv1d(intermediate_chans, intermediate_chans, 3, padding=1)
        self.temporal_conv2 = nn.Conv1d(intermediate_chans, intermediate_chans, 3, padding=1)
        self.out_conv = nn.Conv1d(intermediate_chans, out_chans, 1)
